...
// static signed int * parent = (signed int *) calloc (size,sizeof(signed int));
// static signed int * bfs = (signed int *) calloc (size,sizeof (signed int));
// static signed int *visited = (signed int *) calloc (size,sizeof(signed int));

// static signed int *path = (signed int*) malloc (20*sizeof(signed int));
// static signed int *angle = (signed int*) malloc (20*sizeof(signed int)); // addded the prefix so pathSize needs to be -= 1
signed int pathSize = 0;
